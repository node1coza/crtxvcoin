...
// crtxcoin: total coins staked (non-spendable until maturity)
...
// crtxcoin: get current stake weight
...
// crtxcoin: check 'spent' consistency between wallet and txindex
// crtxcoin: fix wallet spent state according to txindex
...
// crtxcoin: disable transaction (only for coinstake)
