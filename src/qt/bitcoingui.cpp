    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("Crtxvcoin") + " - " + tr("Wallet"));
#ifdef Q_OS_LINUX
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Crtxvcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Crtxvcoin"), this);
    aboutAction->setToolTip(tr("Show information about Crtxvcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Crtxvcoin"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("background-color: #2853FF; color: white");
#else
    //Windows/Mac - Set Purple tabs, white text, tooltips adjusted
    toolbar->setStyleSheet(" QToolTip { color: black; background-color: #F9F8C4}; color: white; background-color: #2853FF");
#endif
...
#ifdef Q_OS_LINUX
    //Linux - Set Purple tabs, white text, tooltips unaffected
    toolbar2->setStyleSheet("background-color: #2853FF");
#else
    //Windows/Mac - Set Purple tabs, tooltips adjusted
    toolbar2->setStyleSheet(" QToolTip { color: black; background-color: #F9F8C4}; background-color: #2853FF");
#endif
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Crtxvcoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Crtxvcoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Crtxvcoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Crtxvcoin address or malformed URI parameters."));
    }
