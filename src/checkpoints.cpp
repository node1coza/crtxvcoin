...
namespace Checkpoints
{
    ...
    // crtxvcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // crtxvcoin: get last synchronized checkpoint
    ...
    // crtxvcoin: only descendant of current sync-checkpoint is allowed
    ...
    // crtxvcoin: reset synchronized checkpoint to last hardened checkpoint
...
// crtxvcoin: sync-checkpoint master key
...
// crtxvcoin: verify signature of sync-checkpoint message
...
// crtxvcoin: process synchronized checkpoint
